...
static PyObject* Turing_Machine_Recur(PyObject* self,
                                      PyObject* args);

static PyMethodDef Turing_Machine_Recur_Methods[] =
{
  { "Turing_Machine_Recur", Turing_Machine_Recur, METH_VARARGS, "Run Turing machine" },
  { NULL                  , NULL                , 0           , NULL                 }
};

PyMODINIT_FUNC initTuring_Machine_Recur(void)
{
  (void)Py_InitModule("Turing_Machine_Recur",Turing_Machine_Recur_Methods);
}
