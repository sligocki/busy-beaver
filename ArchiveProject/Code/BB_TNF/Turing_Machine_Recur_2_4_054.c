...
static PyObject* Turing_Machine_Recur_2_4_054(PyObject* self,
                                      PyObject* args);

static PyMethodDef Turing_Machine_Recur_2_4_054_Methods[] =
{
  { "Turing_Machine_Recur_2_4_054", Turing_Machine_Recur_2_4_054, METH_VARARGS, "Run Turing machine" },
  { NULL                  , NULL                , 0           , NULL                 }
};

PyMODINIT_FUNC initTuring_Machine_Recur_2_4_054(void)
{
  (void)Py_InitModule("Turing_Machine_Recur_2_4_054",Turing_Machine_Recur_2_4_054_Methods);
}
                                      ...
                                      PyObject* args)
{
  ...
  {
    result = step_recur_2_4_054_TM(&tm,i);
