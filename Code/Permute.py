...
def permute_start_state(
  tm: Turing_Machine.Simple_Machine, tnf_max_steps: int
) -> Iterator[Turing_Machine.Simple_Machine]:
...
def main():
  ...
  parser.add_argument(
    "--tnf-max-steps", type=int, default=1_000, help="Maximum number of steps to attempt to find TNF."
  )
