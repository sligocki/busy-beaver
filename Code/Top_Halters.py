...
def main():
  ...
  parser.add_argument(
    ...
    type=int,
    default=20,
    help="Number of top TMs to print (default: 20)",
  )
  parser.add_argument(
    "--expand-1rb",
    action="store_true",
    help="Detect equivalent TMs that start with a 0-writing instruction.",
  )
  ...
  with IO.Reader(args.infile) as reader:
    try:
      ...
      print(
        f"WARNING: Stopped reading early due to partial file / unexpected EOF: {e}",
        file=sys.stderr,
      )
