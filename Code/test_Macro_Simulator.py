...
class MacroSimulatorTest(unittest.TestCase):
  ...
  def test_large_halting(self):
    ...
    data = [
      ("Machines/6x2-e21132-Pavel", 2.604, "((25 + 3^22147)/2)"),
  ...
  def test_giant_halting(self):
    ...
    data = [
      ...
      (
        ...
        None,
        15.604,
        "((-11 + 3^((13 + 3^((23 + 3^((7 + 3^((21 + 3^((7 + 3^((23 + 3^((7 + 3^((23 + 3^((7 + 3^((21 + 3^((7 + 3^((23 + 3^((7 + 3^22146)/8))/8))/8))/8))/8))/8))/8))/8))/8))/8))/8))/8))/8))/2)",  # noqa: E501
      ),
      ...
      (
        ...
        2,
        70.275,
        "(14 + 2^(-1 + 2^(2 + 2^(1 + 2^(-1 + 2^(4 + 2^(2^(-1 + 2^(2^(2 + 2^(2^(2 + 2^(2^(-1 + 2^(2^(-1 + 2^(2^(3 + 2^(2^(3 + 2^(2^(2 + 2^(2^(-1 + 2^(2^(-1 + 2^(2^(2 + 2^(2^(4 + 2^(2^(-1 + 2^(2^(2 + 2^(2^(2 + 2^(2^(-1 + 2^(2^(3 + 2^(2^(-1 + 2^(4 + 2^(2^(-1 + 2^(2^(-1 + 2^(2^(-1 + 2^(2^(4 + 2^(2^(-1 + 2^(2^(-1 + 2^(2^(1 + 2^(1 + 2^(-1 + 2^(4 + 2^(2^(-1 + 2^(2^(2 + 2^(2^(2 + 2^(2^(-1 + 2^(2^258)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))",  # noqa: E501
      ),
    ]
  ...
  def test_non_halting(self):
    ...
    self.assertEqual(tm_record.proto.status.halt_status.inf_reason, io_pb2.INF_CTL)
