...
if __name__ == "__main__":
  ...
  # Enumerate_All.py may be sent an infile param but it should be ignored
  ...
  print "Enumerate_All.py --steps=%s --time=%s --save_freq=%s --seed=%s --outfile=%s --checkpoint=%s%s --states=%s --symbols=%s" % \
