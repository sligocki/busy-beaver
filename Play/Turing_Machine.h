...
#define INDEX(m)  (((m)->position_x) * ((m)->tape_length) + ((m)->position_y))
...
typedef struct
{
  ...
  unsigned long long position_x,position_y;
  unsigned long long max_left,max_down;
  unsigned long long max_right,max_up;
