...
if __name__ == "__main__":
 ...
 # Parse command line options.
  ...
  parser.add_option("-l", "--block-finder-limit", type=int, default=200, help="Number of steps to run the block_finder algorithm for (if manual block size not specified) (Default = %default).")
