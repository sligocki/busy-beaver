...
#  Tools/filter.sh data/bb/4x2/ b2_1k Code/Enumerate.py --block-size=2 --max-loops=1_000 --lin-steps=0 --no-ctl --no-reverse-engineer --outformat=protobuf
#  Tools/filter.sh data/bb/4x2/ 10k Code/Enumerate.py --max-loops=10_000 --lin-steps=0 --no-ctl --no-reverse-engineer --outformat=protobuf
