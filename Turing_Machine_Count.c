...
static PyObject* Turing_Machine_Count(PyObject* self,
                                      PyObject* args);

static PyMethodDef Turing_Machine_Count_Methods[] =
{
  { "Turing_Machine_Count", Turing_Machine_Count, METH_VARARGS, "Run Turing machine" },
  { NULL                  , NULL                , 0           , NULL                 }
};

PyMODINIT_FUNC initTuring_Machine_Count(void)
{
  (void)Py_InitModule("Turing_Machine_Count",Turing_Machine_Count_Methods);
}
