...
# manager.  This is very inefficient when there are 100's # to 1000's of
# processors.
#
...
if __name__ == "__main__":
  if mpi.rank == 0:
    ...
    # Enumerate_Parallel_MW.py may be sent an infile param but it should be ignored
    ...
    print "Enumerate_Parallel_MW.py --steps=%s --time=%s --save_freq=%s --seed=%s --outfile=%s --checkpoint=%s%s --states=%s --symbols=%s" % \
