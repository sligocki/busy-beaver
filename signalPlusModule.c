...
static PyObject *
signalPlus_default_int_handler(PyObject *self, PyObject *args)
{
...
static int
checksignalPluss_witharg(void * unused)
{
	return PyErr_CheckSignals();
}

static void
signalPlus_handler(int sig_num)
{
#ifdef WITH_THREAD
#ifdef WITH_PTH
	...
	if (getpid() == main_pid) {
		...
		Py_AddPendingCall(checksignalPluss_witharg, NULL);
#ifdef WITH_THREAD
	}
#endif
#ifdef SIGCHLD
...
#endif
	PyOS_setsig(sig_num, signalPlus_handler);
}


#ifdef HAVE_ALARM
static PyObject *
signalPlus_alarm(PyObject *self, PyObject *args)
{
	double t;
...
#ifdef HAVE_PAUSE
static PyObject *
signalPlus_pause(PyObject *self)
{
...
static PyObject *
signalPlus_signal(PyObject *self, PyObject *args)
{
	PyObject *obj;
	int sig_num;
...
static PyObject *
signalPlus_getsignal(PyObject *self, PyObject *args)
{
	int sig_num;
	PyObject *old_handler;
...
static PyMethodDef signalPlus_methods[] = {
#ifdef HAVE_ALARM
	{"alarm",	        signalPlus_alarm, METH_VARARGS, alarm_doc},
#endif
	{"signal",	        signalPlus_signal, METH_VARARGS, signal_doc},
	{"getsignal",	        signalPlus_getsignal, METH_VARARGS, getsignal_doc},
#ifdef HAVE_PAUSE
	{"pause",	        (PyCFunction)signalPlus_pause,
	 METH_NOARGS,pause_doc},
#endif
	{"default_int_handler", signalPlus_default_int_handler, 
...
initsignalPlus(void)
{
	...
	m = Py_InitModule3("signalPlus", signalPlus_methods, module_doc);
	if (m == NULL)
		return;
	...
	if (Handlers[SIGINT].func == DefaultHandler) {
		...
		old_siginthandler = PyOS_setsig(SIGINT, signalPlus_handler);
	}
...
{
	initsignalPlus();
	_PyImport_FixupExtension("signalPlus", "signalPlus");
}
